...
def torchscript_to_torchmobile_model(torchscript_model_path='models/Model.pt', torchscript_mobile_model_path='models/MobileModel.pt'):
    os.makedirs(os.path.dirname(torchscript_model_path), exist_ok=True)
...
def onnx_to_tf(onnx_model_path='models/Model.onnx', tf_model_path='models/ModelTF'):
...
def tf_to_tflite(tf_model_path='models/ModelTF', tflite_model_path='models/Model.tflite'):
